...
FREE_OPERATIONS = frozenset((DESCRIBE_TABLE, LIST_TABLES, UPDATE_TABLE, DELETE_TABLE, CREATE_TABLE))
...
SHORT_ATTR_TYPES = frozenset((STRING_SHORT, STRING_SET_SHORT, NUMBER_SHORT, NUMBER_SET_SHORT,
...
COMPARISON_OPERATOR_VALUES = frozenset((EQ, LE, LT, GE, GT, BEGINS_WITH, BETWEEN))
QUERY_OPERATOR_MAP = {
    'eq': EQ,
    'le': LE,
    'lt': LT,
...
COUNT = 'COUNT'
SELECT_VALUES = frozenset((ALL_ATTRIBUTES, ALL_PROJECTED_ATTRIBUTES, SPECIFIC_ATTRIBUTES, COUNT))
SCAN_OPERATOR_MAP = {
    'eq': EQ,
    'ne': NE,
    'le': LE,
...
SCAN_FILTER_VALUES = frozenset((EQ, NE, LE, LT, GE, GT, NOT_NULL, NULL, CONTAINS, NOT_CONTAINS, BEGINS_WITH, IN, BETWEEN))
...
TOTAL = 'TOTAL'
NONE = 'NONE'
RETURN_CONSUMED_CAPACITY_VALUES = frozenset((INDEXES, TOTAL, NONE))
...
SIZE = 'SIZE'
RETURN_ITEM_COLL_METRICS_VALUES = frozenset((SIZE, NONE))
...
RETURN_VALUES_VALUES = frozenset((NONE, ALL_OLD, UPDATED_OLD, ALL_NEW, UPDATED_NEW))
...
DELETE = 'DELETE'
ADD = 'ADD'
ATTR_UPDATE_ACTIONS = frozenset((PUT, DELETE, ADD))
...
AND = 'AND'
OR = 'OR'
CONDITIONAL_OPERATORS = frozenset((AND, OR))
