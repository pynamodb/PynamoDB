...
class Model(metaclass=MetaModel):
    ...
    @overload
    def delete(self, condition: Optional[Any] = ..., conditional_operator: Optional[Text] = ..., in_transaction: TransactWrite = ..., **expected_values) -> None: ...
    ...
    @overload
    def update(self, attributes: Optional[Dict[Text, Dict[Text, Any]]] = ..., actions: Optional[List[Any]] = ..., condition: Optional[Any] = ..., conditional_operator: Optional[Text] = ..., in_transaction: TransactWrite = ..., **expected_values) -> None: ...
    ...
    @overload
    def save(self, condition: Optional[Any] = ..., conditional_operator: Optional[Text] = ..., in_transaction: TransactWrite = ..., **expected_values) -> None: ...
