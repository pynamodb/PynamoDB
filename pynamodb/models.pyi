...
class Model(metaclass=MetaModel):
    ...
    @classmethod
    def condition_check(cls, hash_key: KeyType, in_transaction: TransactWrite, condition: Any, range_key: Optional[KeyType] = ...): ...
    @overload
    def delete(self, condition: Optional[Any] = ..., in_transaction: None = ...) -> Any: ...
    @overload
    def delete(self, condition: Optional[Any] = ..., in_transaction: TransactWrite = ...) -> None: ...
    @overload
    def update(self, actions: Optional[List[Any]] = ..., condition: Optional[Any] = ..., in_transaction: None = ...) -> Any: ...
    @overload
    def update(self, actions: Optional[List[Any]] = ..., condition: Optional[Any] = ..., in_transaction: TransactWrite = ...) -> None: ...
    @overload
    def save(self, condition: Optional[Any] = ..., in_transaction: None = ...) -> Dict[str, Any]: ...
    @overload
    def save(self, condition: Optional[Any], in_transaction: TransactWrite) -> None: ...
    @overload
    def save(self, *, in_transaction: TransactWrite) -> None: ...
