...
class Attribute(Generic[_T]):
    ...
    def __add__(self, other: Any) -> Comparison: ...
    def __radd__(self, other: Any) -> Comparison: ...
    def __sub__(self, other: Any) -> Comparison: ...
    def __rsub__(self, other: Any) -> Comparison: ...
    def __or__(self, other: Any) -> Comparison: ...
