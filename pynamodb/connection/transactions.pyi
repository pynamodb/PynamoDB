...
class TransactGet(Transaction):
    ...
    def get(self, model_cls: Type[_T], hash_key: KeyType, range_key: Optional[KeyType] = ...) -> _T: ...
...
class TransactWrite(Transaction):
    ...
    def add_delete_item(self, model: _T, operation_kwargs: Dict) -> None: ...
    def add_save_item(self, model: _T, operation_kwargs: Dict) -> None: ...
    def add_update_item(self, model: _T, operation_kwargs: Dict) -> None: ...
