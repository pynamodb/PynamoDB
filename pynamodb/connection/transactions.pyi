...
class TransactWrite(Transaction):
    ...
    def _commit(self) -> None: ...
    def condition_check(self, model_cls: Type[ModelType], hash_key: KeyType, range_key: Optional[KeyType] = ..., condition: Any = ...) -> None: ...
    def delete(self, model: ModelType, condition: Optional[Any] = ...) -> None: ...
    def save(self, model: ModelType, condition: Optional[Any] = ..., return_values: Optional[Any] = ...) -> None: ...
    def update(self, model: ModelType, actions: List[Any], condition: Optional[Any] = ..., return_values: Optional[Any] = ...) -> None: ...
