from typing import Set, Tuple, TypeVar, Type, Any, List, Generic, Optional, Dict
...
class Transaction:
    ...
    _hashed_models: Set[Tuple[Type[_T], Any, Any]]
    _proxy_models = List[Generic[_T]]
    ...
    def _hash_model(self, model: Generic[_T], hash_key: Any, range_key: Optional[Any] = ...) -> None: ...
...
class TransactGet(Transaction):
    ...
    def add_get_item(self, model_cls: Type[_T], hash_key: Any, range_key: Optional[Any] = ...) -> Generic[_T]: ...
    def get_results_in_order(self) -> List[Generic[_T]]: ...
...
class TransactWrite(Transaction):
    ...
    def add_delete_item(self, model: Generic[_T], operation_kwargs: Dict) -> None: ...
    def add_save_item(self, model: Generic[_T], operation_kwargs: Dict) -> None: ...
    def add_update_item(self, model: Generic[_T], operation_kwargs: Dict) -> None: ...
