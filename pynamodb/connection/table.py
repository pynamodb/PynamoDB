...
class TableConnection(object):
    ...
    def __init__(self, table_name, region=None, host=None, session_cls=None, retry_enabled=None):
        self._hash_keyname = None
        self._range_keyname = None
        self.table_name = table_name
        self.connection = Connection(region=region, host=host, session_cls=session_cls, retry_enabled=retry_enabled)
