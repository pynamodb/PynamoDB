...
class TransactWrite(Transaction):
    ...
    def delete(self, model: ModelType, condition: ConditionType = ...) -> None: ...
    def save(self, model: ModelType, condition: ConditionType = ..., return_values: Optional[Any] = ...) -> None: ...
    def update(self, model: ModelType, actions: List[Any], condition: ConditionType = ..., return_values: Optional[Any] = ...) -> None: ...
