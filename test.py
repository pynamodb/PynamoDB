...
class NumberIndexForAbstractModel(GlobalSecondaryIndex):
    class Meta:
        index_name = "NumberIndexForAbstractModel"
...
class InheritedNonAbstractModel2(AbstractModel3):
    ...
    class Meta:
        _abstract_ = False
        table_name = "InheritedNonAbstractTable"
        host = "http://localhost:8000"
    #attr6 = ListAttribute()
        attr4_index = NumberIndexForAbstractModel()
...
i = InheritedNonAbstractModel1(3,6)
i.attr6 = 3
i.attr5 = "3"
i.save()
...
class ModelTestCase(TestCase):
    ...
    def test_abstract(self):
        ...
        with patch(PATCH_METHOD, new=fake_db) as req:
            NonAbstractModel.create_table(read_capacity_units=2, write_capacity_units=2)
            InheritedNonAbstractModel.create_table(read_capacity_units=2, write_capacity_units=2)
        pass